    ...
    targets: [
        .target(
            ...
            sources: [
                ...
                "Core/JSONAPI.swift",
                "Core/Moderation.swift",
                "Core/ModerationStore.swift",
                "Core/OpenMensa.swift",
                "Core/PKCE.swift",
                "Core/PlanDerivation.swift",
                "Core/StudIPClient+Courseware.swift",
                "Core/LinuxAttributeShim.swift",
                "Core/ResponseCache.swift",
                "Core/ReviewGate.swift",
